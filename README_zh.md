...
- 原版本: [https://github.com/rankaiyx/gostDroid.git](https://github.com/rankaiyx/gostDroid.git) 需要使用2019年版本的请访问原始库
- 为了方便管理，rankaiyx/gostDroid 的master分支已经删除了，避免拉库异常

## releases 版本说明

- gostDroid_apk_v1.0 是原作者4年前(最后更新时间2019年4月)分支对应的版本，gost版本为v1.9.0 可在[https://github.com/rankaiyx/gostDroid/releases](https://github.com/rankaiyx/gostDroid/releases)查看下载
- gostDroid_dev_apk_gost2.12.0_v2.5.0  系列是对应我自己dev分支的版本，_gost2.12.0代表支持gost官方v2.12.0版本，_v2.5.0为我维护的文件的apk版本号,可在[https://github.com/aspnmy/gostDroid/releases](https://github.com/aspnmy/gostDroid/releases)下载
...
具体使用方法请查看上游说明 [https://github.com/ginuerzh/gost](https://github.com/ginuerzh/gost)
